...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"TeleRynda.TeleRyndaDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"TeleRynda.TeleRyndaDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"TeleRynda.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"TeleRynda Desktop/TeleRynda.lnk"_q;
	const auto old = u"TeleRynda for Windows/TeleRynda.lnk"_q;
