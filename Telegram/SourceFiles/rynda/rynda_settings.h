...
#include "rynda/libs/json.hpp"
#include "rynda/libs/json_ext.hpp"
...
inline void to_json(nlohmann::json &nlohmann_json_j, const TeleRyndaSettings &nlohmann_json_t) {
...
inline void from_json(const nlohmann::json &nlohmann_json_j, TeleRyndaSettings &nlohmann_json_t) {
	const TeleRyndaSettings nlohmann_json_default_obj{};
