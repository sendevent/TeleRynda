...
void FillImportFiltersBox(not_null<Ui::GenericBox*> box, bool import) {
	...
	box->setTitle(import ? tr::rynda_FiltersMenuImport() : tr::rynda_FiltersMenuExport());
	...
	addOption(false, import ? tr::rynda_FiltersImportClipboard(tr::now) : tr::rynda_FiltersExportClipboard(tr::now));
	addOption(true, import ? tr::rynda_FiltersImportURL(tr::now) : tr::rynda_FiltersExportURL(tr::now));
	...
	const auto actionButton = box->addButton(
		import ? tr::rynda_FiltersMenuImport() : tr::rynda_FiltersMenuExport(),
		[=]
		{
