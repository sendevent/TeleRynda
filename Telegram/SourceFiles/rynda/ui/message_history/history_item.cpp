...
#include "rynda/ui/message_history/history_item.h"
...
void GenerateItems(
	...
	const auto entities = RyndaMapper::deserializeTextWithEntities(message.textEntities);
